...
class Session extends React.Component {
  ...
  getSessionInfo() {
    axios.get('http://www.familyworshipapp.com//api/worship_sessions/' + this.stateProps.sessionID)
      .then((response) => {
        ...
        axios.get(bookURL)
          .then((response) => {
            ...
            axios.get('http://www.familyworshipapp.com//api/psalms/psalm/' + firstPsalm)
              .then((response) => {
                this.setState({
                ...
                axios.get('http://www.familyworshipapp.com//api/psalms/psalm/' + secondPsalm)
                  .then((response) => {
                    this.setState({
